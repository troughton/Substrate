        ...
        while SDL_PollEvent(&event) != 0 {
            ...
            case SDL_CONTROLLERBUTTONDOWN:
                ...
                if let inputSource = InputSource(fromGameControllerButton: buttonId) {
                    inputManager.inputState[.gamepad(slot: gamepadSlot)][inputSource] = RawInputState(active: true, frame: inputManager.frame)
                }
            ...
            case SDL_CONTROLLERAXISMOTION:
                ...
                if let inputSource = InputSource(fromGameControllerAxis: axisId) {
                    ...
                    if (value > JoyStickDeadZone || value < -JoyStickDeadZone) {
                        ...
                        inputManager.inputState[.gamepad(slot: gamepadSlot)][inputSource] = RawInputState(value: normalizedValue, frame: inputManager.frame)
                    } else {
