...
open class SDLWindow : Window {
    ...
    public var textureDescriptor : TextureDescriptor {
        return TextureDescriptor.texture2DDescriptor(pixelFormat: self.swapChain.pixelFormat, width: Int(self.drawableSize.width), height: Int(self.drawableSize.height), mipmapped: false)
    }
