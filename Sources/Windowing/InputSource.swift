...
extension DeviceType : Hashable {
    public var hashValue : Int {
        switch self {
        case .mouse: return Int(0).hashValue
        case .keyboard: return Int(1).hashValue
        case .keyboardScanCode: return Int(2).hashValue
        case .gamepad(let slot): return Int(3).hashValue &* slot.hashValue
        }
    }
}
...
extension InputState where T == InputSourceTransitionState {
    mutating func update(rawState: InputState<RawInputState>, frame: UInt32) {
