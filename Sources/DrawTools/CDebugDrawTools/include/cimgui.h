...
typedef struct ImGuiDockFamily ImGuiDockFamily;
...
enum ImGuiTabBarFlags_
{
    ...
    ImGuiTabBarFlags_FittingPolicyResizeDown = 1 << 5,
    ImGuiTabBarFlags_FittingPolicyScroll = 1 << 6,
...
enum ImGuiConfigFlags_
{
    ...
    ImGuiConfigFlags_ViewportsNoTaskBarIcon = 1 << 11,
    ImGuiConfigFlags_ViewportsNoMerge = 1 << 12,
    ImGuiConfigFlags_ViewportsDecoration = 1 << 13,
...
enum ImGuiViewportFlags_
{
    ...
    ImGuiViewportFlags_NoFocusOnAppearing = 1 << 1,
    ImGuiViewportFlags_NoInputs = 1 << 2,
    ImGuiViewportFlags_NoTaskBarIcon = 1 << 3,
    ImGuiViewportFlags_NoRendererClear = 1 << 4,
    ImGuiViewportFlags_TopMost = 1 << 5
};
struct ImGuiViewport
{
    ImGuiID ID;
...
#endif // CIMGUI_SKIP_DEFINE_ENUMS_AND_STRUCTS
...
CIMGUI_API void igDockSpace(ImGuiID id,const ImVec2 size,ImGuiDockNodeFlags flags,const ImGuiDockFamily* dock_family);
CIMGUI_API void igSetNextWindowDockId(ImGuiID dock_id,ImGuiCond cond);
CIMGUI_API void igSetNextWindowDockFamily(const ImGuiDockFamily* dock_family);
...
CIMGUI_API ImDrawList* igGetOverlayDrawListViewportPtr(ImGuiViewport* viewport);
...
CIMGUI_API ImGuiDockFamily* ImGuiDockFamily_ImGuiDockFamily(void);
CIMGUI_API void ImGuiDockFamily_destroy(ImGuiDockFamily* self);
CIMGUI_API ImGuiDockFamily* ImGuiDockFamily_ImGuiDockFamilyID(ImGuiID id,bool compatible_with_family_zero);
