...
{
    return ImGui::DockSpace(id,size,flags,dock_family);
}
...
{
    return ImGui::SetNextWindowDockFamily(dock_family);
}
...
{
    return ImGui::GetOverlayDrawList(viewport);
}
...
{
    return IM_NEW(ImGuiDockFamily)(id,compatible_with_family_zero);
}
