...
open class NSError : NSObject, NSCopying {
    ...
    open var localizedDescription: String {
        ...
        return desc ?? "The operation could not be completed: \(_code)"
    }
    ...
    override open var hashValue: Int {
        ...
        return _domain.hashValue &* 7 &+ _code.hashValue
    }
...
public extension CocoaError {
    ...
    var stringEncoding: String.Encoding? {
        return (_nsUserInfo[NSStringEncodingErrorKey] as? UInt)
        .map { String.Encoding(rawValue: $0) }
    }
